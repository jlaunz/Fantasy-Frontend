    ...
    create() {
        ...
        api.createParty()
            ...
            .then((data) => {
                ...
                if (!sessionStorage.getItem('likedTracks'))
                    sessionStorage.setItem('likedTracks', JSON.stringify([]))
                ...
                this.setRedirect(
                    '/host?roomId=' + data.room_id + '&host_name=' + data.name
                )
            })
            .catch((e) => {
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        updateActiveMusicState: (data) =>
            dispatch(updateActiveMusicState(data)),
    }
}
